...
res = requests.post('https://info512.taifex.com.tw/future/fusaquote_norl.aspx', headers = headers , params = parser)

soup = BeautifulSoup(res.text, 'lxml')

a_tag = soup.select("#ctl00_ContentPlaceHolder1_uc_DgFusaQuote1_dgData")

print (a_tag[0].find_all("tr", class_="custDataGridRow")[2])

s = BeautifulSoup(a_tag[0].find_all("tr", class_="custDataGridRow")[2].get_text(),'lxml')
i_tag = a_tag[0].find_all("tr", class_="custDataGridRow")[2].td.extract()
print (type(a_tag[0].find_all("tr", class_="custDataGridRow")[2]))
print (s)
